...
const jareer = {
  ...
  currentFocus: [
                  'Micro Services', 'NodeJs', 'GraphQL', 'Next.js', 'React.js', 'Vue3', 'Laravel'
                ],
  otherSkills: [
                  'Git', 'Stripe', 'WordPress', 'AWS', 'Docker', 'Jquery', 'Ajax', 'Firebase', 'Figma', 'Photoshop'
               ],
  askMeAbout: [
                  'Software Engineering','Web Development', 'API', 'Tech', 'Automation', 'IOT', 'AI'
              ],
};
